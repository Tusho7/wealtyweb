          ...
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-12">
              <div className="flexibility-image">
                <img src="/images/home-six/flexibility.png" alt="image" />
              </div>
            </div>
                ...
                <div className="row justify-content-center">
                  <div className="col-lg-6 col-md-6">
                    <ul className="list">
                      ...
                      <li>
                        <i className="flaticon-check-mark"></i> Business without
                        borders
                      </li>
                  ...
                  <div className="col-lg-6 col-md-6">
                    <ul className="list">
                      <li>
                        <i className="flaticon-check-mark"></i> A powerful open
                        API
                      </li>

                      <li>
                        <i className="flaticon-check-mark"></i> Affiliates and
                        partnerships
                      </li>
