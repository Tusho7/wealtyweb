...
class Rates extends Component {
  ...
  componentDidMount() {
    axios
      .get(
        `http://api.exchangeratesapi.io/v1/latest?access_key=${this.state.APIKEY}&format=1`
      )
      .then((res) => {
  ...
  render() {
    ...
    return (
      <>
        <div className="currency-rates-area pt-70">
          <div className="container">
            <div className="section-title">
              <h2>Currency Rates</h2>
              <div className="bar"></div>
              <p>
                Latest Currency Rates Based on <strong>EUR</strong>
              </p>
            </div>
